...
export const REQUEST_ALBUMS_ID = 'REQUEST_ALBUMS_ID';
export const RECEIVE_ALBUMS_ID = 'RECEIVE_ALBUMS_ID';
export const REQUEST_ALBUMS_ID_DETAILS = 'REQUEST_ALBUMS_ID_DETAILS';
export const RECEIVE_ALBUMS_ID_DETAILS = 'RECEIVE_ALBUMS_ID_DETAILS';